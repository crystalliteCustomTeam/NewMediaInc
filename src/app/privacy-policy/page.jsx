            ...
            <div className="relative xl:pt-[130px] lg:pt-[100px] md:pt-[80px] py-[40px] bg-black">
                <div className="container">
                    <div className="text-white">
                        <h1 className="text-3xl font-bold border-b pb-2 mb-6">Privacy Policy Statement</h1>

                        <div className="mb-8">
                            <h2 className="text-xl font-semibold mb-2">Commitment to Privacy</h2>
                            <p>Infiniti Media INC is highly committed to keeping client’s personal information safe and secure and we collect only essential and inevitable information to process your order. We never share any of your information with any individual outside our company in any way until you agree to permit us for doing so.</p>
                        </div>
                        ...
                        <div className="mb-8">
                            <h2 className="text-xl font-semibold mb-2">USAGE OF COLLECTED INFORMATION</h2>
                            <p>First of all, the information we collect helps us to understand exactly what product you need and what special things would you require in it and secondly the billing information is inevitable for payment process.</p>
                            <p className="mt-2">The email addresses and phone numbers are used for communication about order status, comments and opinions and delivery of the finalized product.</p>
                            <p className="mt-2">Moreover, we may send sms & emails of update & Promotional Offers on the website, launch of a new product/service and the latest news in the industry. Carrier Charges may apply based on your network.</p>
                            <p className="mt-2">This information also helps us to improve our marketing strategies and compile the record of the most selling products.</p>
                        </div>

                        <div className="mb-8">
                            <h2 className="text-xl font-semibold mb-2">PRIVACY OF PAYMENTS</h2>
                        ...
                        <div className="mb-8">
                            <h2 className="text-xl font-semibold mb-2">CONDITIONS OF INFORMATION DISCLOSURE </h2>
